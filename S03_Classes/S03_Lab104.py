...
Cake.export_1_cake_to_html(cake01, 'd:\Projekty\PyCharm\pythonCourse\S03_Classes\cake01.html')

# class method:
Cake.export_all_cakes_to_html = types.MethodType(export_all_cakes_to_html, Cake)
Cake.export_all_cakes_to_html('d:\Projekty\PyCharm\pythonCourse\S03_Classes\wszystkie_cakes.html')

# instance method:
for c in Cake.bakery_offer:
    c.export_this_cake_to_html = types.MethodType(export_this_cake_to_html, c)
for c in Cake.bakery_offer:
    c.export_this_cake_to_html('d:\Projekty\PyCharm\pythonCourse\S03_Classes\{}.html'.format(c.name.replace(' ', '_')))